...
const iti = window.intlTelInput(phoneInput, {
  ...
  allowDropdown: true, // allows country code dropdown
  autoHideDialCode: false, // optional: keeps dial code visible
  nationalMode: false, // optional: lets user enter full international number
});
...
function updatePhoneInputDisplay() {
  ...
  // You may customize the placeholder here if needed
}

// Call this function initially
updatePhoneInputDisplay();

// Listen for changes to update the placeholder (optional)
